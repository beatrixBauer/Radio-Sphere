    ...
    var body: some View {
        GeometryReader { geometry in
            ...
            VStack {
                ...
                HStack {
                    SleepTimerView(iconSize: isCompact ? 20 : 30)
                    Spacer()
                    LikeButton(station: station, buttonSize: isCompact ? 20 : 30)
                        .frame(maxWidth: .infinity, alignment: .trailing)
                }
                .padding(.horizontal, isCompact ? 20 : 40)
            }
            ...
            .onChange(of: manager.currentStation) { oldStation, newStation in
